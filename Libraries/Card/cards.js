angular.module('myApp', [])
  .controller('CardController', function($scope) {
    $scope.cards = [
      ...
      { image: './Libraries/Card/assets/motherboard.png', name: 'Spare Parts', description: 'Have a plan? Costomise yourself by exploaring parts of your choice!', href: 'page3.html' },
    ];
  });